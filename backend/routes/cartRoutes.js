...
router.post("/", async (req, res) => {
  ...
  try {
    ...
    // Determine the user based on guestId or userId
...
// @desc Delete a product from cart for a guest or logged in user
// @access Public
...
// @route POST /api/cart
// @desc Merge cart for a guest or logged in user
// @access Private
  ...
  try {
    ...
    if (guestCart) {
      ...
      if (userCart) {
        ...
        // If the user cart doesn't exist, create it
      ...
      if (userCart) {
        // Guest cart already merged into user cart, return the user cart
