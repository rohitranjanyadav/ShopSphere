...
const FilterSideBar = () => {
  ...
  useEffect(() => {
    ...
    // {category: "top", gender: "men"} => params.category
        ...
        <div className="flex flex-wrap gap-2">
          {colors.map((color) => (
            <button
              ...
              className={`w-8 h-8 rounded-full border border-gray-300 cursor-pointer transition hover:scale-120 ${filters.color === color ? "ring-2 ring-blue-500" : ""}`}
